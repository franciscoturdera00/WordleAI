...
def manual_parser():
    ...
    parser.add_argument('-wb', '--word-bank', dest='word_bank', default=None,
                        help='File Path to Word Bank to be used for game')
    parser.add_argument('-sb', '--secret-bank', dest='secret_bank', default=None,
                        help='File Path to additional word list that may be used for guessing')
