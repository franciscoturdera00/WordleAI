...
def test_index_decision_with_official_wordle_list(print_mode=False):
    official_list = get_official_list(current_path)
    return test_performance("index_decision", official_list, PERFORMANCE_MARKER, print_mode)


def test_index_decision_with_all_5_letter_words(print_mode=False):
    lst = get_all_5_letter_words(current_path)
...
def run_all():
    value = test_simple_filter_performance_with_official_wordle_list(True)
    ...
    value = test_simple_filter_performance_with_all_5_letter_words(True)
    if args.update_analytics:
    ...
    value = test_smart_guess_with_official_wordle_list(True)
    if args.update_analytics:
    ...
    value = test_smart_guess_with_all_5_letter_words(True)
    if args.update_analytics:
    ...
    value = test_index_decision_with_official_wordle_list(True)
    if args.update_analytics:
    ...
    value = test_index_decision_with_all_5_letter_words(True)
    if args.update_analytics:
...
if __name__ == '__main__':
    ...
    if args.strategy is None or not args.strategy:
        ...
        if Strats.SIMPLE_FILTER_OFFICIAL.value in args.strategy:
            new_value = test_simple_filter_performance_with_official_wordle_list(True)
            if args.update_analytics:
        ...
        if Strats.SIMPLE_FILTER_ALL_5.value in args.strategy:
            new_value = test_simple_filter_performance_with_all_5_letter_words(True)
            if args.update_analytics:
        ...
        if Strats.SMART_GUESS_OFFICIAL.value in args.strategy:
            new_value = test_smart_guess_with_official_wordle_list(True)
            if args.update_analytics:
        ...
        if Strats.SMART_GUESS_ALL_5.value in args.strategy:
            new_value = test_smart_guess_with_all_5_letter_words(True)
            if args.update_analytics:
        ...
        if Strats.INDEX_DECISION_OFFICIAL.value in args.strategy:
            new_value = test_index_decision_with_official_wordle_list(True)
            if args.update_analytics:
        ...
        if Strats.INDEX_DECISION_ALL_5.value in args.strategy:
            new_value = test_index_decision_with_all_5_letter_words(True)
            if args.update_analytics:
